...
<div class="language-switcher" style="position: absolute; top: 75px; right: 10px;">
    ...
    <div class="table-container bg-white p-4 rounded shadow-sm">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="../usuarios/" class="btn btn-outline-dark d-flex align-items-center gap-1 fw-bold">
                    <span><i class="fa-solid fa-users"></i></span> <span id='geuser'>Gerenciar Usuários</span>
                </a>
                <?php endif; ?>
                <?php if ($usuario_nivel === '1' || $usuario_nivel === '2'): ?>
                <a href="../cadativ/" class="btn btn-primary d-flex align-items-center gap-1 fw-bold">
                    <span><i class="fa-solid fa-plus"></i></span> <span id='cadativ'>Cadastrar Atividade</span>
                </a>
                <?php endif; ?>
            </div>            
        </div>
        ...
        <div class="table-responsive">
            <table id="tabelaAtividades" class="table table-hover align-middle width-100 table-striped">
                ...
                <tbody>
                    <?php if ($dados_atividades->num_rows > 0): ?>
                        <?php while($row = $dados_atividades->fetch_assoc()): ?>
                            <tr>
                                <td>
                                    <img src="../img/img_atividades/<?php echo $row['img']; ?>" width='100'>
                                </td>
                                <td>
  ...
  function setLanguage(lang) {
    ...
    const translations = {
      ...
      es: {
            ...
            acoespedagogicas: "Acciones Pedagógicas y Culturales",
    ...
    document.getElementById("ola").innerText = t.ola;
    document.getElementById("ferramentas").innerText = t.ferramentas;
    document.getElementById("sair").innerText = t.sair;
    document.getElementById("relatoriog").innerText = t.relatoriog;
    document.getElementById("totalacoes").innerText = t.totalacoes;
    document.getElementById("planejamento").innerText = t.planejamento;
    document.getElementById("executadas").innerText = t.executadas;
    document.getElementById("acoeseixo").innerText = t.acoeseixo;
    document.getElementById("distribuicaoprojeto").innerText = t.distribuicaoprojeto;
    document.getElementById("statusespaco").innerText = t.statusespaco;
    document.getElementById("acoesplanejadas").innerText = t.acoesplanejadas;
    document.getElementById("publicoeixo").innerText = t.publicoeixo;
    document.getElementById("somaparticipantes").innerText = t.somaparticipantes;
    document.getElementById("acoespedagogicas").innerText = t.acoespedagogicas;
    document.getElementById("memoria").innerText = t.memoria;
    document.getElementById("geuser").innerText = t.geuser;
    document.getElementById("cadativ").innerText = t.cadativ;
    document.getElementById("tituloproj").innerText = t.tituloproj;
    document.getElementById("tituloeixo").innerText = t.tituloeixo;
    document.getElementById("tituloperi").innerText = t.tituloperi;
    document.getElementById("tituloespaco").innerText = t.tituloespaco;
    document.getElementById("tituloperiodo").innerText = t.tituloperiodo;
    document.getElementById("titulostatus").innerText = t.titulostatus;
    document.getElementById("tituloescopo").innerText = t.tituloescopo;
    document.getElementById("tituloacoes").innerText = t.tituloacoes;
